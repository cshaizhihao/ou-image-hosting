...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.0.0--rc.1-ef8f8f" alt="Version 1.0.0-rc.1" />
  <img src="https://img.shields.io/badge/progress-9%20%2F%2010-303030" alt="Round 9 of 10" />
...
- 新增 7、30、90 天数据统计控制台，展示当前图片、期间新增、真实分享访问和去重后的原图版本占用
- 新增原生 SVG 趋势图、格式分布、热门图片、读屏数据表与上传/分享访问数据覆盖说明
- 新增仅站点 Owner 可访问的系统状态页、主动健康检查、架构模式、后台任务和失败任务重试
- PostgreSQL、Redis 和 CDN 以“未配置”或“已配置但未投入当前架构”的中性状态展示，不伪装成已启用
- 设置中心新增站点公开信息、上传上限、允许格式、处理质量、缩略图、本地化和默认外观
- 站点设置仅 Owner 可管理；工作区运行设置所有成员可读，仅 Admin/Owner 可保存
- 增加真实离线横幅、明确权限错误、浅色/深色和桌面/移动响应式状态
- 新增数据统计、系统状态、站点与处理设置及移动端深色真实截图
- 34 个自动化测试通过，并完成低 CPU 类型检查、构建与响应式浏览器验证

## 应用截图

### v1.0.0-rc.1 数据统计、系统状态与设置

<p align="center">
  <img src="./docs/screenshots/v1.0.0-rc.1-analytics.png" width="49%" alt="OU-Image Hosting 数据统计控制台" />
  <img src="./docs/screenshots/v1.0.0-rc.1-system.png" width="49%" alt="OU-Image Hosting 系统健康状态与后台任务" />
</p>

<p align="center">
  <img src="./docs/screenshots/v1.0.0-rc.1-settings.png" width="66%" alt="OU-Image Hosting 站点与图片处理设置" />
  <img src="./docs/screenshots/v1.0.0-rc.1-analytics-mobile-dark.png" width="280" alt="OU-Image Hosting 移动端深色数据统计" />
</p>
...
- Operations：真实上传/分享访问统计、系统状态快照、按需健康检查与 Owner 后台任务视图
